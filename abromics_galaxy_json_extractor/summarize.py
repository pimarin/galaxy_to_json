...
class ReportSummary:
    ...
    def _read_json_input(self, report):
        ...
        """
        validated_file = self._check_input_files(report)
        if validated_file != 0:
    ...
    def export_summary(self):
        ...
        output_destination = self._check_output_path()
        self.summary_json_list = [
            self._read_json_input(report) for report in self._report_list
        ]
        json.dump(
            self.summary_json_list,
            output_destination,
