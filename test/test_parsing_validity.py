...
def test_rgi_variants():
    ...
    parsed_report = ABRomicsonization.parse("data/dummy/rgi/rgi_var.txt", metadata, "rgi")
...
def test_rgi_orf_mode():
    ...
    parsed_report = ABRomicsonization.parse("data/dummy/rgi/rgi_orf.txt", metadata, "rgi")
...
def test_rgi():
    ...
    parsed_report = ABRomicsonization.parse("data/dummy/rgi/rgi.txt", metadata, "rgi")
